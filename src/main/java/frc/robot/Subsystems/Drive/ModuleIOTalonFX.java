...
public class ModuleIOTalonFX implements ModuleIO {
  ...
  public ModuleIOTalonFX(ModuleConfig config) {
    ...
    turnConfig.MotorOutput.Inverted = config.turnInverted()
    ...
    cancoderConfig.MagnetSensor.SensorDirection = config.encoderInverted()
    ...
    drivePositionQueue = PhoenixOdometryThread.getInstance().registerSignal(driveTalon.getPosition().clone());
    ...
    turnPositionQueue = PhoenixOdometryThread.getInstance().registerSignal(turnTalon.getPosition().clone());
