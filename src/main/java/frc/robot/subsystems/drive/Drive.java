...
public class Drive extends SubsystemBase {
    ...
    private static final LoggedTunableNumber coastWaitTime = new LoggedTunableNumber("Drive Coast Wait Time Seconds",
            0.5);
    private static final LoggedTunableNumber coastMetersPerSecondThreshold = new LoggedTunableNumber(
            "Drive Coast Meters Per Sec Threshold", .05);
    ...
    public void periodic() {
        ...
        double[] sampleTimestamps = Constants.robotMode == Mode.SIM
